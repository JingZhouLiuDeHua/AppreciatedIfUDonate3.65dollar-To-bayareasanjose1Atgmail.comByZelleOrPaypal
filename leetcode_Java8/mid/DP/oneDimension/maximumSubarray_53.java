package leetcode.mid.DP.oneDimension;
...
public class maximumSubarray_53 {
	        ...
	        public int maxSubArray(int[] arr) {
	            ...
	            for (int i = 1; i < arr.length; i++){ 
	               ...
	               res = Math.max(res, curr_max); // jing zhou liu de hua yuan chuang 2019 07
	            } 
	            return res; 
	        }
	        ...
	        public List<Integer> maxSubArraySumReturnSubarray(int arr[]){ 
	            ...
	            int maxSum = Integer.MIN_VALUE, 
	            	curr_max = 0,start = 0, 
	                end = 0, s = 0; // jing zhou liu de hua yuan chuang 2019 07
	            ...
	            for (int i = 0; i < arr.length; i++){ 
	                ...
	                if (maxSum < curr_max){ 
	                	maxSum = curr_max; 
	                    start = s; 
	                    end = i; // jing zhou liu de hua yuan chuang 2019 07
	                } 	      
	                if (curr_max < 0){ 
	                	curr_max = 0; 
	                    s = i + 1; 
